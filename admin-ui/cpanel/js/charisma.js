$(document).ready(function () {
    ...
    function switchTheme(themeName) {
        if (themeName == 'classic') {
            $('#bs-css').attr('href', "{{ asset('/admin-ui/cpanel/bower_components/bootstrap/dist/css/bootstrap.min.css') }}");
        } else {
            $('#bs-css').attr('href', "{{ asset('/admin-ui/cpanel/css/bootstrap-' + themeName + '.min.css') }}");
        }
